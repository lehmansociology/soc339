...
#What is x minus y?  Enter the code to make this calculation below, rather than the numerical answer.
...
Now you pick two variables that you'd like to see a scatterplot of.  Take a look at the states data.  Remember you can pull up the dataset by entering the command View(states) into the console below.  Use the same code as above, only change the x and y variables to ones that you'd like to see.  Note that R is case sensitive, so you will have to capitalize exactly as the variable names are displayed in the dataset.
...
Once you've completed all chunks of this template, you are ready to knit to PDF.
