...
As with the previous labs, we'll import the population of the USA from the Human Mortality Database for years 1933 to 2017 into RStudio.  Enter in your username and password information for mortality.org as before.
...
You may recognize this chunk from the fertility lab.  Here we are importing and formatting the data on births for each year 1933 to 2017.
...
You may recognize this chunk from the mortality lab.  Here we are importing and formatting the data on deaths for each year 1933 to 2017.
...
ggplot(migration_by_year, aes(x=Year, y=Net_Migration, ymax=4000000)) + 
  ...
  geom_line() + 
  ggtitle("US Net Migration 1933-2017 (in Millions)")
