...
ASFRdata <- subset(ASFRdata, Year<=2015)
...
Let's take a look at what ASFR has looked like across the years 1933 to 2015.

```{r}

ggplot(data = ASFRdata, aes(x = Age, y = ASFR, color=Year)) + geom_line(aes(group=Year)) + ggtitle("US ASFR 1933-2015")
...
Now let's graph the TFR from 1933-2015.

```{r}

ggplot(TFRdata, aes(x = Year, y = TFR)) + geom_line() + ggtitle("US Total Fertility Rate 1933-2015")
